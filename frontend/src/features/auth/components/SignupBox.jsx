...
function SignupBox() {
  return (
    <div className="bg-[#1C1C1E] p-10 rounded-xl shadow-2xl w-[450px] text-center mx-auto my-auto border border-[#333333]">
      ...
      <h2 className="text-2xl font-semibold mb-2 text-white">Create Your StudioOps Account</h2>
      <p className="mb-8 text-gray-400 text-sm">Join the next generation of creative workflow management.</p>

      <div className="text-left mb-6 relative">
        <label htmlFor="companyName" className="block mb-2 text-gray-300 text-sm font-medium">Company Name</label>
        <div className="flex items-center bg-[#2C2C2E] rounded-lg p-3">
          <input type="text" id="companyName" placeholder="Enter your company's name" className="flex-1 bg-transparent border-none focus:outline-none text-white text-sm" />
        </div>
      </div>

      <div className="text-left mb-6 relative">
        <label htmlFor="fullName" className="block mb-2 text-gray-300 text-sm font-medium">Full Name</label>
        <div className="flex items-center bg-[#2C2C2E] rounded-lg p-3">
          <input type="text" id="fullName" placeholder="Enter your full name" className="flex-1 bg-transparent border-none focus:outline-none text-white text-sm" />
        </div>
      </div>

      <div className="text-left mb-6 relative">
        <label htmlFor="workEmail" className="block mb-2 text-gray-300 text-sm font-medium">Work Email Address</label>
        <div className="flex items-center bg-[#2C2C2E] rounded-lg p-3">
          <input type="email" id="workEmail" placeholder="Enter your work email" className="flex-1 bg-transparent border-none focus:outline-none text-white text-sm" />
        </div>
      </div>

      <div className="text-left mb-6 relative">
        <label htmlFor="createPassword" className="block mb-2 text-gray-300 text-sm font-medium">Create Password</label>
        <div className="flex items-center bg-[#2C2C2E] rounded-lg p-3">
          ...
          <input type="password" id="createPassword" placeholder="Enter a secure password" className="flex-1 bg-transparent border-none focus:outline-none text-white text-sm" />
      ...
      <button className="w-full py-3 bg-blue-600 hover:bg-blue-700 border-none rounded-lg text-white text-lg font-bold cursor-pointer mt-6 mb-6 transition-all duration-300 shadow-lg shadow-blue-500/30">Create Account</button>
      ...
      <p className="text-sm text-gray-400">
        Already have an account? <Link to="/login" className="text-blue-400 no-underline font-bold hover:text-blue-300 transition-colors duration-200">Log In</Link>
      </p>
    </div>
  );
}
